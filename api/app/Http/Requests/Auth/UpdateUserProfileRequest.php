...
class UpdateUserProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nationalCode' => ['required', 'string', 'min:10', 'max:10', 'regex:/^[0-9]{10}$/'],

            'mobile' => ['required', 'string', 'regex:/^09+[0-9]{9}$/'],
            'phone' => ['sometimes', 'string', 'regex:/^[0-9]{9,11}$/'],

            'address' => ['required', 'string'],
            'zipcode' => ['required', 'string', 'min:10', 'max:10', 'regex:/^[0-9]{10}$/'],

            'workAddress' => ['sometimes', 'nullable', 'string'],
            'workPhone' => ['sometimes', 'nullable', 'string', 'regex:/^[0-9]{9,11}$/'],
